    ...
    <div class="container contato-cadastro-box">
        <div class="row" style="margin-top:0px;margin-bottom: 0px;padding-bottom: 40px">
            <div class="col-md-6">
                ...
                <iframe style="float: right;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3828.475125029426!2d-49.51231206341763!3d-16.34974171576393!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x935dd7e1d7521103%3A0x1644e2e377076424!2sAv.+Bernardo+Say%C3%A3o%2C+604%2C+Inhumas+-+GO%2C+75400-000!5e0!3m2!1spt-BR!2sbr!4v1506397133603" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <div class="col-md-6">
                <div style="height: 50px;line-height: 50px;width: 230px;margin: auto;margin-top: 40px;margin-bottom: 30px;">
                    <div style="float: left;">
                ...
                <p style="padding: 40px">Entre em contato no nosso telefone: <strong>(62) 3514 - 5771</strong><br>
        ...
        <form id="form-contato" method="POST" onsubmit="return validar(this)">
            <div class="form-group">
                <label><span class="obrigatorio">*</span>Nome:</label>
                <input type="text" class="form-control" style="width: 300px" id="nome" name="nome" data-alt="Nome" data-ob="1">
            </div>
            <div class="form-group">
                <label>Telefone:</label>
                <input type="text" class="form-control" style="width: 300px" id="telefone" name="telefone" data-alt="Telefone" data-ob="0">
            </div>
            <div class="form-group">
                <label><span class="obrigatorio">*</span>Celular:</label>
                <input type="text" class="form-control" id="celular" style="width: 300px" name="celular" data-alt="Celular" data-ob="1">
            </div>
            <div class="form-group">
                <label><span class="obrigatorio">*</span>Endereço de e-mail:</label>
                <input type="text" class="form-control" id="email" style="width: 300px" name="email" data-alt="E-mail" data-ob="1">
            </div>
            <div class="form-group">
                <label><span class="obrigatorio">*</span>Assunto:</label>
                <input type="text" class="form-control" id="assunto" name="assunto" style="width: 300px" data-alt="Assunto" data-ob="1">
            </div>
            <div class="form-group">
