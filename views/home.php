<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL;?>/assets/css/style-home.css">
    ...
    <div class="home-cap-img">
        <h3>DuLar Enxovais</h3>
        <p>PRODUTOS DIRETO DA FÁBRICA<br>SUA FAMÍLIA MERECE!</p>
        <div id="botao-transparente"><a href="<?php echo BASE_URL;?>/produtos">Veja os produtos</a></div>
        <div id="div-branca"></div>
    </div>
</div>
<div class="container-fluid home-preferencias">
    <h3>Aqui temos o que a sua família precisa</h3>
