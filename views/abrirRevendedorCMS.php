...
<div class="container main">
    ...
    <button class="btn btn-primary" onclick="location.href = '<?php echo BASE_URL;?>/revendedoresCMS'">Voltar</button>
    ...
    <div class="box" style="margin-top: 10px">
        ...
        <div class="box-body">
            ...
            <p>Investimento Inicial: <?php echo $revendedor['investimentoinicial'] ?></p>
        </div>
    </div>
