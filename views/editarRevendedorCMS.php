...
<div class="main">
    <button class="btn btn-primary" style="margin-bottom: 10px;cursor: pointer" onclick="location.href = '<?php echo BASE_URL ?>/revendedoresCMS/abrir/<?php echo base64_encode(base64_encode($revendedor['id'])) ?>'">Voltar</button>
                    ...
                    <div class="conteudo">
                        ...
                        <div class="row row1">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label><span class="obrigatorio">*</span>Investimento Inicial:</label>
                                    <input type="text" class="form-control" id="investimentoinicial" name="investimentoinicial" data-alt="Investimento Inicial" data-ob="1" value="<?php echo $revendedor['investimentoinicial'];?>">
                                </div>
